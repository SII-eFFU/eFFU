...
//        recognizer.rotation = 0
    ...
    @objc func tapAction(sender:UITapGestureRecognizer){
        ...
        //Test point
//        let point = CustomPointAnnotation(coordinate: zoneTouchCoordinates, title: "", subtitle: "" )
//                point.reuseIdentifier = ""
//                point.image = UIImage(named: "")
//                mapView.addAnnotation(point)
        ...
        let secondLocation = CLLocation(latitude: airportsDatabase[i]!.swLatitude, longitude: airportsDatabase[i]!.swLongitude)
            ...
            if distance < distanceMax {
                ...
                data.append(["\(airportsDatabase[i]!.aiIcao)"])
